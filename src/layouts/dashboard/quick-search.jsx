    ...
    sx={{
        ...
        <Modal open={isOpen}>
            <Box sx={{
                ...
                backgroundColor: theme.palette.background.paper,
                boxShadow: 24,
                borderRadius: 1, minWidth: "50%", minHeight: "50%"
            }}>
                <Stack direction="row" alignItems="center" sx={{pl: 2, pr: 2,pt: 2, width: '100%',mb: 1, pb: 1, borderBottom: `1px solid ${theme.palette.divider}`}}>
                    <SearchIcon color="inherit" sx={{fontSize: 22 }} />
                    <input
                    ref={inputRef}
                    label=""
                    style={{width: '100%',
                     borderBottom: 0, borderColor: 0,
